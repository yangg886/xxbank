...
https://fcloud.zjtlcb.com/huokeapi/XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
post
报文重放
...
headers1 = {
    ...
    # ,'PE-AJAX': 'true'
    ,
    'Referer': 'https://fcloud.zjtlcb.com/dc/sdkH5/?bussType=060&c=L081011&wxCode=oSTQctyt0GZt-M0bhypS-Q0rf9dE&wechatID=tlbank1993&qrcodeBlngSys=IBANK'
...
def process1(tel) -> int:
    ...
    ooo = "{\"bussType\":\"TAIELOAN\",\"channelId\":\"L081011\",\"mobile\":\"18100007766\",\"txSno\":\"HD1686731545743\"}"
    sign = md5(ooo)
    #print(sign)
    '''
	sign = md5(ooo)
